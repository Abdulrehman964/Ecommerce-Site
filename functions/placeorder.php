...
if(isset($_SESSION['buyer']))
{
    ...
    if(isset($_POST['placeOrderBtn']))
    {
        ...
        $userId = $_SESSION['buyer_user']['user_id'];
        $query = "SELECT c.id as cid, c.prod_id, c.prod_qty, p.id as pid,p.name, p.image, 
        ...
        $tracking_no = "coding".rand(1111,9999).substr($phone,2);
        $insert_query = "INSERT INTO orders (tracking_no, user_id,	name, email, phone, address, pincode, total_price, payment_mode) VALUES ('$tracking_no', '$userId', '$name', '$email', '$phone', '$address', '$pincode', '$totalPrice', '$payment_mode')";
